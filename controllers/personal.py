...
def add_form():
    ...
    if (not(None in dic.values())):
        ...
        db.t_Materia_nueva.update_or_insert(
            ...
            f_fecha_inicio_materia_1 = dic["f_fecha_inicio_materia_1"],
            f_fecha_final_materia_1 = dic["f_fecha_final_materia_1"],
            f_area_1 = dic["f_area_1"],
            f_codigo_1 = dic["f_codigo_1"],
            f_nombre_materia_1 = dic["f_nombre_materia_1"],
            f_fecha_inicio_materia_2 = dic["f_fecha_inicio_materia_2"],
            f_fecha_final_materia_2 = dic["f_fecha_final_materia_2"],
            f_area_2 = dic["f_area_2"],
            f_codigo_2 = dic["f_codigo_2"],
            f_nombre_materia_2 = dic["f_nombre_materia_2"],
            f_fecha_inicio_materia_3 = dic["f_fecha_inicio_materia_3"],
            f_fecha_final_materia_3 = dic["f_fecha_final_materia_3"],
            f_area_3 = dic["f_area_3"],
            f_codigo_3 = dic["f_codigo_3"],
            f_nombre_materia_3 = dic["f_nombre_materia_3"],
            f_fecha_inicio_materia_4 = dic["f_fecha_inicio_materia_4"],
            f_fecha_final_materia_4 = dic["f_fecha_final_materia_4"],
            f_area_4 = dic["f_area_4"],
            f_codigo_4 = dic["f_codigo_4"],
            f_nombre_materia_4 = dic["f_nombre_materia_4"],
            f_fecha_inicio_materia_5 = dic["f_fecha_inicio_materia_5"],
            f_fecha_final_materia_5 = dic["f_fecha_final_materia_5"],
